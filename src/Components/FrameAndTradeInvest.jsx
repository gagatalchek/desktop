const FrameAndTradeInvest = () => {
  return (
    <div className=" flex  flex-col m-auto">
      ...
      <div>
        <div className="p-[36px] flex w-[594px] flex-col justify-center items-center rounded-[24px] border-solid border-[1px] border-[#30363D] bg-[#161B22] "></div>
      </div>
    </div>
  );
};
